...
class Less_Tree_Selector extends Less_Tree
{
    ...
    public function match($other)
    {
        if (
            !$other->_oelements ||
            $this->elements_len < $other->_oelements_len
        ) {
            return 0;
        }
    ...
    public function CacheElements()
    {
        ...
        $this->_oelements_len = preg_match_all(
            '/[,&#\.\w-](?:[\w-]|(?:\\\\.))*/',
            $css,
            $matches
        );
    ...
    {
        return !isset($this->currentFileInfo['reference']) ||
