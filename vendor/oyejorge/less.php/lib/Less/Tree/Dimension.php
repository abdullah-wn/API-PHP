...
class Less_Tree_Dimension extends Less_Tree
{
    ...
    {
        if (
            Less_Parser::$options['strictUnits'] &&
    ...
    public function operate($op, $other)
    {
        ...
        if ($op === '+' || $op === '-') {
            ...
            $unit->numerator = array_merge(
                $unit->numerator,
                $other->unit->numerator
            );
            $unit->denominator = array_merge(
                $unit->denominator,
                $other->unit->denominator
            );
            sort($unit->numerator);
